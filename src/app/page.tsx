    ...
    <div className="bg-slate-50 grainy-light bg">
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 mx-w-prose sm:text-lg space-y-2 w-fit">
            <li className="w-fit">
            ...
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5" />
              Scatch- and fingerprints resistant coating{" "}
            </li>
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5" />
            ...
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5" />6 year
              print warranty
            </li>
